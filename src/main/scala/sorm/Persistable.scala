...
/**
 *
 * A class must inherit this mixin
 *
 ...
 * Since the `_id` property value is meant to be generated by database, it is protected from the user of being able to manually specify it as well as letting the case classes have such a property.
 * So, instead of
 * {{{
...
trait Persistable {
  ...
  override def equals(other: Any): Boolean = other match {
    case other: Persistable => _id == other._id
    case _ => false
  }
}
